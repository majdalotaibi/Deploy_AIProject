...
#     </style>
#     <div class="navbar">
#         <a href="#" onclick="window.location.href='/Gharsa'; return false;">الرئيسية</a>
#         <a href="#" onclick="window.location.href='/Plants_info'; return false;">تعرف على النباتات</a>
#         <a href="#" onclick="window.location.href='/what_is_the_plant'; return false;">ماهي نبتتي؟</a>
#         <a href="#" onclick="window.location.href='/Plant_your_plant'; return false;">ازرع نبتتك</a>
#         <a href="#" onclick="window.location.href='/Check_your_plant'; return false;">افحص نبتتك</a>
#         <a href="#" onclick="window.location.href='/Team_members'; return false;">الأعضاء</a>
#     </div>
# """, unsafe_allow_html=True)
...
def load_page(page):
    if page == 'Gharsa':
        st.title("الرئيسية")
    elif page == 'Plants_info':
        st.title("تعرف على النباتات")
    elif page == 'what_is_the_plant':
        st.title("ماهي نبتتي؟")
    elif page == 'Plant_your_plant':
        st.title("ازرع نبتتك")
    elif page == 'Check_your_plant':
        st.title("افحص نبتتك")
    elif page == 'Team_members':
        st.title("الأعضاء")
